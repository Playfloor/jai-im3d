...
static const Im3d::DrawList *g_Im3dDrawLists;
static int g_Im3dDrawListCount;
...
void Im3d_EndFrame()
{
 ...
 // Primitive rendering.
	...
	g_Im3dDrawLists = Im3d::GetDrawLists ();
	g_Im3dDrawListCount = Im3d::GetDrawListCount ();

	for (U32 i = 0; i < g_Im3dDrawListCount; ++i)
	{
		const Im3d::DrawList& drawList = g_Im3dDrawLists[i];
