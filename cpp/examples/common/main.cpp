...
int main(int, char**)
{
	...
	printf ("Im3d::DrawList is %d bytes\n", sizeof (Im3d::DrawList));
	printf ("Im3d::Context is %d bytes\n", sizeof (Im3d::Context));
	printf ("Im3d::GizmoMode is %d bytes\n", sizeof (Im3d::GizmoMode));
	printf ("Im3d::VertexData is %d bytes\n", sizeof (Im3d::VertexData));
	printf ("Im3d::TextData is %d bytes\n", sizeof (Im3d::TextData));
